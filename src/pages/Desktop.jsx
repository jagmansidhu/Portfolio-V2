...
const folders = [
  { label: 'experience', to: '/experience', style: { top: '20%', left: '14%' }, delay: 0.18, rotate: -4 },
  ...
  return (
    <main className="desktop">
      <div className="desktop-stage">
        ...
        >
          <h1 className="desktop-script">jagman</h1>
